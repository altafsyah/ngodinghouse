    ...
    <>
      <section id="hero" className="w-full max-w-7xl mx-auto pt-32">
        <div className="flex">
          ...
          <h2 className="text-2xl font-medium max-w-4xl">
            At Arsa Studio, we're passionate about crafting digital experiences
            that inspire. With expertise in web and app development, we turn
            ideas into reality, empowering businesses to thrive in the digital
            age.
          </h2>
        </div>
      ...
      <section className="w-full max-w-7xl grid grid-cols-2 mt-20 mx-auto gap-24">
        <div>
          ...
          <h5 className="mt-8 text-2xl font-medium">
            At Arsa Studio, we uphold integrity, innovation, and excellence in
            every project. With a commitment to quality and client satisfaction,
            we deliver transformative software solutions that drive success.
          </h5>
        </div>
        <div className="text-white">
          <div className="bg-black1 px-10 py-8 rounded-xl">
            ...
            <h4 className="text-description mt-2">
              Integrity is fundamental at Arsa Studio. It ensures trust,
              transparency, and reliability in all our endeavors, fostering
          ...
          <div className="bg-black1 px-10 py-8 rounded-xl mt-6">
            ...
            <h4 className="text-description mt-2">
              Innovation drives Arsa Studio's pursuit of cutting-edge solutions,
              ensuring continuous growth and relevance in the digital landscape.
            </h4>
          </div>
          <div className="bg-black1 px-10 py-8 rounded-xl mt-6">
            <h3 className="text-subtitle font-bold">Excellence</h3>
            <h4 className="text-description mt-2">
              Excellence defines Arsa Studio's commitment to delivering superior
      ...
      <section id="process" className="w-full max-w-7xl mx-auto mt-20 pb-24">
        ...
        <h5 className="mt-2 text-2xl font-medium">
          Arsa Studio's process integrates creativity, collaboration, and
          precision to ensure seamless development and delivery of innovative
          software solutions.
        </h5>
